<div style="display: flex; align-items: center; font-family: 'Arial', sans-serif; color: #2c3e50; justify-content: flex-start; gap: 15px;">
  <!-- Profile Picture -->
  ...
  <div style="flex: 1; display: flex; flex-direction: column; text-align: right;">
    <h1 style="font-size: 1.5em; color: #34495e; margin: 0; line-height: 1;">فلوکی</h1>
    <p style="font-size: 1em; color: #2c3e50; line-height: 1.6; max-width: 400px; margin: 10px 0 0 0;">
